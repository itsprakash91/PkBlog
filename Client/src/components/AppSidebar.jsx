    ...
    <Sidebar>
      <SidebarHeader className="bg-sidebar border-b border-sidebar-border">
        <Link to="/" className="block p-2">
          <span className="text-lg font-bold bg-gradient-to-r from-primary to-primary/80 text-primary-foreground px-3 py-1.5 rounded-xl tracking-tight shadow-sm">PkBlog</span>
        </Link>
      </SidebarHeader>
